...
The collection is considered "authentic" if it is a permutation of an array base[n]. The base[n] array is defined as 
[1, 2, ..., n - 1, n, n], meaning it is an array of length n + 1 containing the integers from 1 to n - 1 exactly once,
...
def is_authentic_collection(art_pieces):
    ...
    actual_freq = Counter(art_pieces)
    return expected_freq == actual_freq
